...
class TemperatureController extends Controller
{
    ...
    public function listByHour(Request $request){
        ...
        $dataByHour = DB::table('meteorology as m')
            ->join('station','m.id_station','=','station.id_station')
            ->select(DB::raw('HOUR(m.monitoring_time) as hour'),
                DB::raw('DAY(m.monitoring_date) as day'),
                DB::raw('AVG(m.temperature) as averange'),
                'm.id_station',
                'm.monitoring_date',
                'station.name')
            ->whereDate('m.monitoring_date',$startDate)
            ->groupBy(DB::raw('HOUR(m.monitoring_time)'),DB::raw('DAY(m.monitoring_date)'),'m.id_station','m.monitoring_date','station.name')
            ->get();
    ...
    public function listByDay(Request $request){
        ...
        $dataByDay = DB::table('meteorology as h')
            ...
            ->select(DB::raw('DAY(h.monitoring_date) as day'),
                ...
                DB::raw('AVG(h.temperature) as averange'),
                'h.id_station',
                'station.name')
    ...
    public function listByMonth(Request $request){
        ...
        $dataByMonth = DB::table('meteorology as h')
            ->join('station','h.id_station','=','station.id_station')
