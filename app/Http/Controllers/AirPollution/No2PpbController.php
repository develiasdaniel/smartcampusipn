...
class No2PpbController extends Controller
{
    public function listByHour(Request $request){
        ...
        $dataByHour = DB::table('air_pollution_historical as h')
            ...
            ->select(DB::raw('HOUR(h.monitoring_time) as hour'),
                ...
                DB::raw('AVG(h.no2_ppb) as averange'),
                'h.id_station',
                'h.monitoring_date',
                'station.name')
    ...
    public function listByDay(Request $request){
        ...
        $dataByDay = DB::table('air_pollution_historical as h')
            ->join('station','h.id_station','=','station.id_station')
    ...
    public function listByMonth(Request $request){
        ...
        $dataByMonth = DB::table('air_pollution_historical as h')
            ->join('station','h.id_station','=','station.id_station')
