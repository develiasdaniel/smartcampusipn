...
<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show bg-background-cic" id="sidebar">
    ...
    <ul class="c-sidebar-nav ps ps--active-y">
        ...
        <li class="c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li @click="menu=21" class="c-sidebar-nav-item"><a id="btn-coreui" class="c-sidebar-nav-link" href="#"> Regresión Lineal</a></li>                
                <li @click="menu=22" class="c-sidebar-nav-item"><a id="btn-coreui" class="c-sidebar-nav-link" href="#"> Soporte de Máquinas Vectoriales</a></li>
        ...
        <li class="c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li @click="menu=17" class="c-sidebar-nav-item">
                    <a id="btn-coreui" class="c-sidebar-nav-link" href="#" target="_top">
                    <div class="c-sidebar-nav-icon">
                        <i class="cil-user-follow"></i>
                    </div> Usuarios</a>
                </li>
                <li @click="menu=18" class="c-sidebar-nav-item">
                    <a id="btn-coreui" class="c-sidebar-nav-link" href="#" target="_top">
                    <div class="c-sidebar-nav-icon">
                        <i class="cil-wc"></i>
                    </div>  Roles</a>
                </li>
                <li @click="menu=19" class="c-sidebar-nav-item">
                    <a id="btn-coreui" class="c-sidebar-nav-link" href="#" target="_top">
                    <div class="c-sidebar-nav-icon">
                        <i class="cil-walk"></i>
                    </div>  Ocupaciones</a>
        ...
        <li class="c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">                
                ...
                <li @click="menu=20" class="c-sidebar-nav-item">
                    <a id="btn-coreui" class="c-sidebar-nav-link" href="#" target="_top">
                    <div class="c-sidebar-nav-icon">
                        <i class="cil-home"></i>
                    </div> Zonas</a>
